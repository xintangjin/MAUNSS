    ...
    def __init__(
        ...
        for _ in range(num_blocks):
            self.blocks.append(nn.ModuleList([
                ...
                SwinTransformerBlock(dim=dim, input_resolution=(660 // (2 ** stage), 714 // (2 ** stage)),
...
class SST_block(nn.Module):
    def __init__(self, dim=28):
        ...
        # Input projection
        self.embedding = nn.Conv2d(29, 28, 3, 1, 1, bias=False)
        ...
        self.inter_conv2 = nn.Conv2d(56, 28, 1, 1, bias=False)
        self.bottle1 = nn.Conv2d(28 * 7, 28, 1, 1, bias=False)
        self.bottle2 = nn.Conv2d(28 * 7, 28, 1, 1, bias=False)
...
class HyPaNet(nn.Module):
    def __init__(self, in_nc=29, out_nc=3, channel=64):
...
class create_alpha_beta(nn.Module):
    def __init__(self):
        ...
        self.fution = nn.Conv2d(56, 64, 1, 1, 0, bias=True)
...
class OLU(nn.Module):
    ...
    def __init__(self, num_iterations=7):
        ...
        self.denoiser_body = SST_block(dim=28)

        self.denoiser_end = SST_block(dim=28)
